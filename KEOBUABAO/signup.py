...
class SignUp():
    def __init__(self, login):
        ...
        self.img = Image.open(r"D:\SẢN PHẨM SNLTW\SNLTW_HP3_SP\KEOBUABAO\image\popup-banner.jpg")
        ...
        self.icon = Image.open(r"D:\SẢN PHẨM SNLTW\SNLTW_HP3_SP\KEOBUABAO\image\newuser.png")
        ...
        self.userNamelabel = Label(self.window, text='Họ và tên', font=('Verdana', 13), bg='AliceBlue')
        self.userNamelabel.place(x=480, y=70)

        self.userNameInput = Entry(self.window, width=22, bd=2, font=('Verdana', 13))
        self.userNameInput.place(x=400, y=110)

        self.emaillabel = Label(self.window, text='Địa chỉ email', font=('Verdana', 13), bg='AliceBlue')
        self.emaillabel.place(x=470, y=140)

        self.emailNameInput = Entry(self.window, width=22, bd=2, font=('Verdana', 13))
        ...
        self.comBobox['values'] = ('Chọn quê quán', 'BinhDuong', 'Bình Phước', 'Tây Ninh', 'Đồng Nai')
    ...
    def thongbao(self):
        ...
        if self.userNameInput.get().strip() == '':
            ...
            f = open(r'''D:\SẢN PHẨM SNLTW\SNLTW_HP3_SP\KEOBUABAO\user.txt''', 'a+')
