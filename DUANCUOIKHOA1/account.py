...
class Account():
    def __init__(self, window, currentUser):
        self.window = window
        self.currentUser = currentUser[0]
        self.img = Image.open(r"D:\SẢN PHẨM SNLTW\SNLTW_HP3_SP\DUANCUOIKHOA1\image\user.png")
        ...
        self.lineframe4 = Frame(self.window, height=1, background='white', width=600)
